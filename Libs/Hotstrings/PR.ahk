...
{
  ClipSaved := ClipboardAll()
  A_Clipboard := "gh pr create --draft --base data-platform-integration/main --assignee '@me' --reviewer 'tomoharu-miyazawa_t7s' --title '顧客データ基盤連携 | xxx' --body '## PBI`r`n`r`n`r`n`r`n## 対象SBI`r`n`r`n`r`n`r`n## 補足`r`n`r`n`r`n'"
  Send("^v")
  Sleep(50)
  A_Clipboard := ClipSaved
}
